  ...
  return (
    <div className="mx-auto max-w-2xl space-y-6">
      <div>
        ...
        <p className="mt-1 text-slate-600">Add a new course to the learning platform.</p>
      </div>
      ...
      >
        <div>
          ...
          <input
            ...
            className="mt-1 w-full rounded-lg border border-slate-300 px-4 py-2.5 outline-none focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20"
