...
export default function CourseCard({ course, showProgress = false, action }) {
  ...
  return (
    <div className="flex flex-col overflow-hidden rounded-xl border border-slate-200 bg-white shadow-sm transition-all hover:shadow-md dark:border-slate-700 dark:bg-slate-900">
      <Link
      ...
      <div className="flex flex-1 flex-col p-4">
        ...
        <p className="mt-1 line-clamp-2 flex-1 text-sm text-slate-600 dark:text-slate-300">
        ...
        {course.enrollment?.completed && (
          <span className="mt-2 inline-flex w-fit rounded-full bg-green-50 px-2 py-0.5 text-xs font-medium text-green-700 dark:bg-green-950 dark:text-green-400">
            Completed
          </span>
        )}
